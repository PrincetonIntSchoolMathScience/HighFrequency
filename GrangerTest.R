...
egg<-ts(as.numeric(CompareData$summary.score))
chic<-ts(as.numeric(CompareData$CLOSE))
...
CompareData$close_num <- as.numeric(CompareData$CLOSE)

grangertest(CompareData$summary.score, CompareData$close_num)
